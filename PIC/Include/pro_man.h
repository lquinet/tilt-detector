...
extern void _restore_ctx(void);           // ==> Added
extern void _restore_stack(void);         // ==> Added
/***********************************************************************
 * ----------------------------- Defines -------------------------------
 **********************************************************************/
...
#define RESTORE_TASK_CTX    _asm    goto _restore_stack	  _endasm     /* ==> Added */
...
#define CTX_SAVED   0x08     /* ==> Added state Context is Saved Already */
