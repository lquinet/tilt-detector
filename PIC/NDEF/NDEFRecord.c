...
void NdefRecordConstructor(void)
{
    ...
    // Type = 'T': encodage du payload en texte
    NdefRecord._type[0] = 'T';
    NdefRecord._Teminator[0]=0xFE;
    NdefRecord._Teminator[1]=0x00;
...
//    az = (float)accelCount[2]*aRes;
    ...
    // Print out values
//    PrintLogFloatValue("x-acc = %s mg; ",1000.*ax );
//    PrintLogFloatValue("y-acc = %s mg; ",1000.*ay );
//    PrintLogFloatValue("z-acc = %s mg\r",1000.*az );
