...
/**
 * Created by michael on 13-04-16.
 */
public class Advance extends Activity{
    ...
    //private String statebutton = "false";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ResetButton = (Button) this.findViewById(R.id.btnReset);
        WriteBlockButton = (Button) this.findViewById(R.id.btnWriteBlock);
        ReadBlockButton = (Button) this.findViewById(R.id.btnReadBlock);
        uidButton = (Button) this.findViewById(R.id.btnUID);
        ConfigButton = (Button) this.findViewById(R.id.btnConf);

        ResetButton.setOnClickListener(reset);
        WriteBlockButton.setOnClickListener(writeblock);
        ReadBlockButton.setOnClickListener(readblock);
        uidButton.setOnClickListener(readuid);
        ConfigButton.setOnClickListener(config);
    }

    View.OnClickListener reset = new View.OnClickListener(){
        public void onClick(View v){
            new StartResetTask().execute();
        }
    };

    View.OnClickListener writeblock = new View.OnClickListener(){
        public void onClick(View v){
            Intent i = new Intent(Advance.this, WriteBlock.class);
            startActivity(i);
        }
    };/**/

    View.OnClickListener readblock = new View.OnClickListener(){
        public void onClick(View v){
            Intent i = new Intent(Advance.this, ReadBlock.class);
            startActivity(i);
        }
    };

    View.OnClickListener readuid = new View.OnClickListener(){
        public void onClick(View v){
            Intent intentScan = new Intent(Advance.this, IdIdentification.class);
    ...
    View.OnClickListener config = new View.OnClickListener(){
        public void onClick(View v){
            Intent intentScan = new Intent(Advance.this, Config.class);
            startActivity(intentScan);
        }
    };
    ...
    private class StartResetTask extends AsyncTask<Void, Void, Void>
    {
        private final ProgressDialog dialog = new ProgressDialog(Advance.this);
        ...
        protected Void doInBackground(Void... params)
        {
            ...
            if(DecodeGetSystemInfoResponse(GetSystemInfoAnswer))
            {
                ...
                //
                String secondAddressString = "07FB"; //Block number to reset the card (07FA)
                ...
                //String valueBlock5 = "",valueBlock6="",valueBlock7="",valueBlock8="";

                String valueBlock5 = Helper.ConvertHexByteToString(date);
                String valueBlock6 = Helper.ConvertHexByteToString(month);
                String valueBlock7 = Helper.ConvertHexByteToString(year);
                String valueBlock8 = Helper.ConvertHexByteToString(hour);

                Log.v("date", String.valueOf(date));
                Log.v("date hex", valueBlock5);
                Log.v("date hex", Integer.toHexString(date));
                Log.v("month", String.valueOf(month));
                Log.v("month hex", valueBlock6);
                Log.v("year", String.valueOf(year));
                Log.v("year hex", Integer.toHexString(year));
                ...
                String thirdAddressString = "07FC"; //Block number to reset the card (07FA)
                ...
                String valueBlock9 = Helper.ConvertHexByteToString(minute);
                String valueBlock10 = Helper.ConvertHexByteToString(second);
                String valueBlock11 = "FF";
                String valueBlock12 = "FF";
