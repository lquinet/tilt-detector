...
public class WriteBlock extends Activity {
    ...
    //public static String EXTRA_1= "false";

    @Override
    protected void onCreate(Bundle savedInstanceState)
    {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.block_write);                            //Affichage layout write.xml
    ...
    {
        private final ProgressDialog dialog = new ProgressDialog(WriteBlock.this);
