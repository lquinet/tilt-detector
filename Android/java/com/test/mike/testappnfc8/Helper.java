...
public class Helper {
	...
	public static String ConvertHexByteToString (int intToConvert)
	{
		String ConvertedInt = "";

			if (intToConvert < 0) {
				ConvertedInt += Integer.toHexString(intToConvert);
			} else if (intToConvert <= 15) {
				ConvertedInt += "0" + Integer.toHexString(intToConvert);
			} else {
				ConvertedInt += Integer.toHexString(intToConvert);
			}
		return ConvertedInt;
